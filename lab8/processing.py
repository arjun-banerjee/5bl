...
vr=np.array([0.1,0.4,0.7,1.0,1.3,1.6,1.9,2.2,2.5,2.9,3.3])
...
vg=np.array([2.1,2.2,2.3,2.4,2.5,2.7,2.9,3.1,3.2,3.3])
...
vred=np.array([1.6,1.7,1.8,2.0,2.2,2.4,2.5,2.8,3.0,3.2,3.3])
